            ...
            <div class=" col-md-12 ">
				<div class="media align-items-center bg-white mb-20">
				  ...
				  <div class="media-body">
					<h3><strong>Modulo de Administracion de Usuarios para Web Master</strong></h3>
				  </div>
				</div>
			</div>
    ...
    <form  method="POST" v-on:submit.prevent="updateUsuarios(fillusuarios.id)">
        <!-- Modal -->
				  ...
				  <div class="modal-dialog modal-lg">
					<div class="modal-content">
					  ...
					  <div class="modal-header bg-mo">
						<h5 class="modal-title">Edicion Datos de Usuario para Web Master</h5>
            ...
            <div class="col s12" >
                 ...
                 <div class="box card-inverse bg-img" style="background-image: url(images/fondo-vendedores.jpg); padding-top: 250px">

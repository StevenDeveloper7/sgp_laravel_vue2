                ...
                <div class=" col-md-12 ">
                    <div class="media align-items-center bg-white mb-20">
                        ...
                        <div class="media-body">
                            <h3><strong>Aquí gestionas las categorías de tus productos ve!</strong></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-mo">
                            <h5 class="modal-title">Crea una Nueva Categoría del Producto ve!</h5>
                            <button
                                type="button"
                                class="close"
                                data-dismiss="modal"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col s12">
                                    <div class="box card-inverse bg-img" style="background-image: url(images/fondo-categorias.jpg); padding-top: 100px">
        ...
        >
            ...
            >
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-mo">
                            <h5 class="modal-title">Actualiza tu Categoría ve!</h5>
                            <button
                                type="button"
                                class="close"
                                data-dismiss="modal"
...
export default {
    ...
    methods: {
        ...
        updateCategorias(id) {
            ...
            this.$http({
                url: "auth/categoria_productos/" + id,
                method: "PUT",
                data: {
        ...
        deleteCategorias(categoria) {
            this.$swal({
                ...
                if (result.value) {
                    ...
                    this.$http({
                        url: "auth/categoria_productos/" + categoria.id,
                        method: "DELETE"
                    })
                        .then(response => {
                            this.getCategorias();

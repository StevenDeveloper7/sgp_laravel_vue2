...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Rerporte de Comisiones</title>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            ...
            <th class="unit">VENDEDOR</th>
            <th class="qyt">TIPO</th>
        ...
        <tbody>
          ...
          <tr>
            <td class="no">{{$comision->id}}</td>
            <td class="desc">{{ date('d-m-Y', strtotime($comision->fecha) ) }}</td>
            <td class="unit">{{$comision->nombre_vendedor}}</td>
            <td class="qyt">{{ $comision->tipo_comision }}</td>
